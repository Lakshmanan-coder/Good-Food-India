...
<form method="POST" action="{{ route('register') }}" class="form-horizontal m-t-20">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        ...
        <div class="col-12">
            <input id="phoneno" type="text" class="form-control @error('phoneno') is-invalid @enderror" name="phoneno" value="{{ old('phoneno') }}" required autocomplete="phoneno" autofocus placeholder="Phone No.">
